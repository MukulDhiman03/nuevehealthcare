    ...
    return (
        <div className="dark:bg-[var(--bg-gray-color)] dark:text-white">
            <div className=" px-6 py-12 max-w-4xl mx-auto space-y-6">
                <h1 className="text-4xl font-bold mb-6">Letrozole</h1>
                ...
                <div className="flex flex-wrap gap-4 pt-6">
                    <button className="px-6 py-3 rounded custom_buttons">Request a Quote</button>
                    <button className="px-6 py-3 rounded custom_buttons">Request a Sample</button>
                    <button className="px-6 py-3 rounded custom_buttons">Download Technical Data Sheet</button>
                </div>
            </div>
        </div>
    );
